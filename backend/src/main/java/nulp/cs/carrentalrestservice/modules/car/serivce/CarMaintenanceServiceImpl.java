...
import nulp.cs.carrentalrestservice.modules.car.mapper.CarMaintenanceMapper;
import nulp.cs.carrentalrestservice.modules.car.CarScheduleMapper;
...
import nulp.cs.carrentalrestservice.modules.car.repository.CarMaintenanceRepository;
    ...
    public Optional<CarMaintenanceDTO> updateCarMaintenanceById(UUID id, CarMaintenanceDTO carMaintenanceDTO) {
        ...
        carMaintenanceRepository.findById(id).ifPresentOrElse(foundMaintenance -> {
            ...
            foundMaintenance.setSchedule(carScheduleMapper.carScheduleDtoToCarSchedule(
                    scheduleService.updateCarScheduleById(updatedScheduleDTO, updatedScheduleDTO.getId()).get()));
