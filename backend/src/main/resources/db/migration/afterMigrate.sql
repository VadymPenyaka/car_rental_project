...
INSERT INTO cars (fuel_consumption, fuel_type, number_of_seats, car_pricing_id, id, brand, model, car_class, gearbox_type, location_id, engine_capacity, drive_type, number, color, VIN, year, body_type, fuel_tank_capacity, trunk_capacity)
VALUES (13, 'DIESEL', 5, 'a08456f3-4c7e-4a9b-bc51-d7ec8b621bfb', 'b231afa5-79df-4597-ac6f-4f410fac85b4', 'BMW', 'X5', 'BUSINESS', 'AUTO', '2d65947e-78ca-482a-9356-af6e929f5fbe', 3.0, 'FRONT_WD', '12345ABCD12345', 'Red', '1HGBH41JXMN109186', 2020, 'SEDAN', 50, 400);
INSERT INTO cars (fuel_consumption, fuel_type, number_of_seats, car_pricing_id, id, brand, model, car_class, gearbox_type, location_id, engine_capacity, drive_type, number, color, VIN, year, body_type, fuel_tank_capacity, trunk_capacity)
VALUES (9, 'GASOLINE', 5, '2e5ea1c7-4e5c-4330-a19c-e034f97f97c2', '05c398e4-de14-4c91-b8d6-0b3364c619b2', 'BMW', 'X6', 'COMFORT', 'AUTO', '2d65947e-78ca-482a-9356-af6e929f5fbe', 2.0, 'FRONT_WD', '67890XYZ98765', 'Blue', '1HGBH41JXMN109187', 2021, 'HATCHBACK', 45, 350);
