            ...
            <Card className="bg-transparent shadow-none">
                ...
                <CardContent>
                    <p className="text-sm text-gray-300">
                        © {new Date().getFullYear()} 5Cars, Inc.
                        <br />
                        All rights reserved.
                    </p>
                </CardContent>
            ...
            <Card className="bg-transparent shadow-none">
                ...
                <CardContent>
                    ...
                    {["Home", "Fleet", "About Us", "Contact"].map((link) => (
						<Link to={link} className="text-sm hover:text-white text-gray-300 hover:underline transition-colors duration-200">
                            {link}
                        </Link>
                    ))}
					</div>
            ...
            <Card className="bg-transparent shadow-none text-gray-300">
                ...
                <CardContent>
                    ...
                    <div className="flex space-x-4 mt-4">
                        <Logo src={phone} width="14rem" />
                        <p>+38 (067) 521 78 77</p>
                        <Logo src={viber} width="20rem" />
                        <Logo src={telegram} width="20rem" />
                        <Logo src={whatsup} width="20rem" />
                    </div>
                </CardContent>
            </Card>
        </div>
